...
jc882@cornell.edu}
\and
\IEEEauthorblockN{Daniel M. Romero}
...
% We make this prediction under
% the assumption that at least one directed edge exists between $v$ and $w$.  
...
% an edge is symmetric or asymmetric after removing all information 
% about the potential edges in question, 
% using existing information about $v$ and $w$.
...
\end{tikzpicture}}
\end{figure}
The importance of ``friends of friends,'' or people two links away from a given node, lends itself to exploring features that directly arise  from the directed @-message graph. 
There are essentially four types of two-step hops (shown in Figure \ref{fig_2step}) corresponding to either the number of common in-neighbors or out-neighbors (mutual neighbors), or the number of directed paths from $v$ to $w$ or from $w$ to $v$ (two-step paths). 
...
\bibitem{kwak-what-is-twitter}
H.~Kwak, C.~Lee, H.~Park, and S.~B. Moon, ``What is Twitter, a social network
  or a news media?'' in \emph{Proc. 19th Intl. WWW
  Conf.}, 2010. 
%, pp. 591--600.

\bibitem{romero-directed-closure}
D.~M. Romero and J.~M. Kleinberg, ``The directed closure process in hybrid
  social-information networks, with an analysis of link formation on Twitter,''
  in \emph{Proc. 4th Intl. Conf. on Weblogs and Social Media},
  2010.

\bibitem{Tyler:2003tq}
J.~R. Tyler and J.~C. Tang, ``{When Can I Expect an Email Response? A Study of
  Rhythms in Email Usage},'' in \emph{ECSCW'03: Proceedings of the eighth
  conference on European Conference on Computer Supported Cooperative
  Work}.\hskip 1em plus 0.5em minus 0.4em\relax Kluwer Academic Publishers,
  Sep. 2003.

\bibitem{liben-nowell-link-pred}
D.~Liben-Nowell and J.~Kleinberg, ``The link-prediction problem for social
  networks,'' \emph{Journal of the American Society for Information Science and
  Technology}, vol.~58, no.~7, pp. 1019--1031, 2007.

\bibitem{gilbert-tie-strength}
E.~Gilbert and K.~Karahalios, ``Predicting tie strength with social media,'' in
  \emph{Proc. 27th ACM Conference on Human Factors in Computing Systems}, 2009,
  pp. 211--220.

\bibitem{leskovec-chi10}
J.~Leskovec, D.~Huttenlocher, and J.~Kleinberg, ``Signed networks in social
  media,'' in \emph{Proc. 28th ACM Conference on Human Factors in Computing
  Systems}, 2010, pp. 1361--1370.

\bibitem{Romero:2011:DMI:1963405.1963503}
D.~M. Romero, B.~Meeder, and J.~Kleinberg, ``Differences in the mechanics of
  information diffusion across topics: Idioms, political hashtags, and complex
  contagion on Twitter,'' in \emph{Proc. 20th Intl.
  WWW Conf.}, 2011.

\bibitem{graph:common-neighbors}
M.~E.~J. Newman, ``{Clustering and preferential attachment in growing
  networks},'' \emph{Physical Review E}, no.~2, pp. 025\,102+, Jul. 2001.

\bibitem{Salton:86}
G.~Salton and M.~J. Mcgill, \emph{{Introduction to Modern Information
  Retrieval}}.\hskip 1em plus 0.5em minus 0.4em\relax New York, NY, USA:
  McGraw-Hill, Inc., 1986.

\bibitem{Adamic:2003ud}
L.~Adamic, ``{Friends and Neighbors on the Web},'' \emph{Social Networks}, 
  2003.

\bibitem{Barabasi:2002}
A.~Barabasi, H.~Jeong, Z.~Neda, E.~Ravasz, A.~Schubert, and T.~Vicsek,
  ``{Evolution of the social network of scientific collaborations},''
  \emph{Physica A: Statistical Mechanics and its Applications}, 
vol. 311, 2002.
% vol. 311, no.  3-4, pp. 590--614, Aug. 2002.

\bibitem{Katz:1953un}
L.~Katz, ``{A New Status Index Derived From Sociometric Analysis},''
  \emph{Psychometrika}, 1953.
