...
We focus our analysis on the subgraph $G_{1000}$ induced by users who authored at least 1000 @-messages, and only consider an edge $(v,w)$ to be present if both $v$ and $w$ have authored 1000 @-messages each.
