...
is {\em unreciprocated} if only $v \xrightarrow{k} w$.
...
and out links) is a very powerful preditor for reciprocity.
...
Tables \ref{table_recresults_logr}---\ref{table_recresults_lograll3}.
