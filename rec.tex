...
The two-step paths ratio is simply the ratio of number of [DIRECTED OR UNDIRECTED?] two-step paths from $v$ to $w$ to that from $w$ to $v$. 
...
of 0.760 [CHECK THIS NUMBER- doesn't agree with table], while the decision tree for link prediction only
